...
public class ConfigurableZooKeeperPing extends AbstractZooKeeperPing {
    ...
    @Property
    protected int connection_timeout = Constants.DEFAULT_CONNECTION_TIMEOUT_MS;

    @Property
    protected int session_timeout = Constants.DEFAULT_SESSION_TIMEOUT_MS;

    @Property
    protected int max_retry = Constants.MAX_RETRIES_LIMIT;

    @Property
    protected int retry_interval = Constants.DEFAULT_RETRY_INTERVAL;
